  ...
  return (
    <div className="space-y-6 pt-6">
      ...
      <p className="text-justify text-gray-500">
        Мы являемся одним из ведущих продавцов спортивных товаров в интернете.
        Наша команда состоит из профессионалов, которые любят спорт и заботятся
        о том, чтобы каждый клиент получил лучший опыт покупок. Мы предлагаем
        широкий ассортимент спортивных товаров от лучших мировых брендов. У нас
        вы найдете все необходимое для занятий любым видом спорта: от футбола до
        йоги. Наш каталог включает в себя одежду, обувь, аксессуары и
        оборудование для тренировок. Мы гарантируем высокое качество всех наших
        товаров и быструю доставку по всей территории России. Кроме того, мы
        предоставляем бесплатную консультацию по выбору товара и помощь в
        оформлении заказа. Мы ценим каждого клиента и стараемся сделать все
        возможное, чтобы удовлетворить его потребности. Если у вас есть
        какие-либо вопросы или нужна помощь при выборе товара, пожалуйста,
        свяжитесь с нами. Благодарим вас за выбор нашего магазина!
      </p>
